...
if [[ "${KCNC_ALLOW_UNSAFE_TUN:-}" != "1" ]]; then
  ...
  echo "Use /home/kcnc/code/tools/vibe-practicum-vpn/scripts/kcnc-safe-tun-disable.sh to rollback/cleanup." >&2
...
timeout 5 bash -lc "</dev/tcp/$VPS_TS_IP/$VPS_SOCKS_PORT" || {
  ...
  echo "Rollback: /home/kcnc/code/tools/vibe-practicum-vpn/scripts/kcnc-safe-tun-disable.sh" >&2
  exit 1
}
...
echo "Enabled. Disable with: /home/kcnc/code/tools/vibe-practicum-vpn/scripts/kcnc-safe-tun-disable.sh"
