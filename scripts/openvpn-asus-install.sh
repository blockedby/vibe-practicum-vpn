...
OPENVPN_VPN_CIDR="${OPENVPN_VPN_CIDR:-10.231.89.0/24}"
OPENVPN_VPN_NET="${OPENVPN_VPN_NET:-10.231.89.0}"
OPENVPN_VPN_MASK="${OPENVPN_VPN_MASK:-255.255.255.0}"
OPENVPN_VPN_GATEWAY="${OPENVPN_VPN_GATEWAY:-10.231.89.1}"
OPENVPN_ASUS_VPN_IP="${OPENVPN_ASUS_VPN_IP:-10.231.89.2}"
OPENVPN_CLIENT_POOL_START="${OPENVPN_CLIENT_POOL_START:-10.231.89.20}"
OPENVPN_CLIENT_POOL_END="${OPENVPN_CLIENT_POOL_END:-10.231.89.254}"
