...
Usage:
  scripts/asus/openvpn-asus-pool-tproxy-profile.sh --export <client-cn>
  scripts/asus/openvpn-asus-pool-tproxy-profile.sh --dry-run <client-cn>
...
Examples:
  PUBLIC_ENDPOINT=${VPNKIT_VPS_PUBLIC_ENDPOINT:-203.0.113.10} OUT_DIR=/home/kcnc/vibe-openvpn-asus-profile \
    scripts/asus/openvpn-asus-pool-tproxy-profile.sh --export vasya-phone
