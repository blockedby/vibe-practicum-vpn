...
scripts/vpnkit/vpnkit-prod-singbox-dns-migration.sh
...
scripts/vpnkit/vpnkit-prod-singbox-dns-migration.sh:59:    -e 's#vless://[^[:space:]]+#vless://[redacted]#g' \
scripts/deck/vpnkit-steamdeck-podman.sh:82:    -e 's#vless://[^[:space:]]+#vless://[redacted]#g' \
