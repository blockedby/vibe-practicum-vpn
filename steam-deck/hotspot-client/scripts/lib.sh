...
# Values exported by the operator for a single invocation should override .env.
ENV_VPNKIT_DECK_CLIENT_CONTAINER=${VPNKIT_DECK_CLIENT_CONTAINER-}
ENV_VPNKIT_DECK_CLIENT_IMAGE=${VPNKIT_DECK_CLIENT_IMAGE-}
ENV_VPNKIT_DECK_CLIENT_PROFILE=${VPNKIT_DECK_CLIENT_PROFILE-}
ENV_VPNKIT_DECK_LOG_DIR=${VPNKIT_DECK_LOG_DIR-}
ENV_VPNKIT_DECK_VPN_IFACE=${VPNKIT_DECK_VPN_IFACE-}
ENV_VPNKIT_DECK_REPORT_DIR=${VPNKIT_DECK_REPORT_DIR-}
ENV_VPNKIT_DECK_PODMAN=${VPNKIT_DECK_PODMAN-}
if [[ -r "$ENV_FILE" ]]; then
  set -a
...
[[ -n "$ENV_VPNKIT_DECK_CLIENT_CONTAINER" ]] && VPNKIT_DECK_CLIENT_CONTAINER=$ENV_VPNKIT_DECK_CLIENT_CONTAINER
[[ -n "$ENV_VPNKIT_DECK_CLIENT_IMAGE" ]] && VPNKIT_DECK_CLIENT_IMAGE=$ENV_VPNKIT_DECK_CLIENT_IMAGE
[[ -n "$ENV_VPNKIT_DECK_CLIENT_PROFILE" ]] && VPNKIT_DECK_CLIENT_PROFILE=$ENV_VPNKIT_DECK_CLIENT_PROFILE
[[ -n "$ENV_VPNKIT_DECK_LOG_DIR" ]] && VPNKIT_DECK_LOG_DIR=$ENV_VPNKIT_DECK_LOG_DIR
[[ -n "$ENV_VPNKIT_DECK_VPN_IFACE" ]] && VPNKIT_DECK_VPN_IFACE=$ENV_VPNKIT_DECK_VPN_IFACE
[[ -n "$ENV_VPNKIT_DECK_REPORT_DIR" ]] && VPNKIT_DECK_REPORT_DIR=$ENV_VPNKIT_DECK_REPORT_DIR
[[ -n "$ENV_VPNKIT_DECK_PODMAN" ]] && VPNKIT_DECK_PODMAN=$ENV_VPNKIT_DECK_PODMAN
